...
def print_rdp_troubleshooting(ip_addr: str):
    trouble_text = (
        ...
        "     [bold red]Uncheck[/bold red] 'Require computers to use Network Level Authentication to connect'\n"
        "     and click '[bold cyan]Proceed anyway[/bold cyan]' on the warning prompt.\n"
        "     (NLA does not support network login with empty passwords by default).\n\n"
        ...
        "     If you are using a custom ISO with RDP stripped out, this method\n"
        "     will not work. (Try a standard ISO instead).\n\n"
        ...
        "       c. In the [bold]left-hand navigation tree[/bold], expand the [bold]Local Policies[/bold] folder\n"
        "          and click directly on the [bold]Security Options[/bold] folder. (Do not stay at the root!).\n"
        "       d. In the right pane, find and double-click the policy:\n"
        "          '[bold]Accounts: Limit local account use of blank passwords to console logon only[/bold]'.\n"
        "       e. Select [bold green]Disabled[/bold green], click Apply, and click OK.\n"
        ...
        "          and set the DWORD [bold]LimitBlankPasswordUse[/bold] to [bold]0[/bold].\n\n"

...
SCHEMA = {
    ...
    0: [
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="timedatectl set-timezone $(timedatectl list-timezones | fzf --prompt='Select System Timezone > ')",
            group="Region & Input",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="localectl set-locale LANG=$(grep -v '^#' /etc/locale.gen | awk '{print $1}' | fzf --prompt='Select System LANG Locale > ')",
            group="Region & Input",
        ...
        ConfigItem(
            ...
            scope="DEFAULT",
            type_="action",
            default="localectl set-keymap $(localectl list-keymaps | fzf --prompt='Select TTY Keymap > ')",
            group="Region & Input",
